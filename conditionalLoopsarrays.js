...
roster.splice(process.argv[3],1)
console.log(roster)
...
if (Catchattempt < catchChance) { console.log("Caught it!")
...
if (roster < 6) {console.log(roster.push("_____"))}
console.log(roster)
...
const elements = ["grass","fire","water"];
